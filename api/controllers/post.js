...
export const getPost = (req, res) => {
    const q = "SELECT p.id, username, title, `desc`, p.img, u.img AS userImg, category, `date` FROM users u JOIN posts p ON u.id = p.userid WHERE p.id = ?"
...
export const addPost = (req, res) => {
    ...
    jwt.verify(token, "jwtkey", (err, userInfo)=>{
        ...
        const q = "INSERT INTO posts(title, `desc`, img, category, `date`, userid) VALUES (?)"
